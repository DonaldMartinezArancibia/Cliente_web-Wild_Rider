...
export default function Header({ pageContext }) {
  ...
  return (
    <header className="w-full text-white font-Montserrat">
      <div className="bg-black w-full grid grid-cols-[1fr_1fr_1fr_12%] grid-rows-[1fr] p-[10px_10px_10px] rounded-tr-2xl rounded-tl-2xl">
        ...
        <div className="self-center text-center">
          <p className="mb-2 px-6 font-medium">
        ...
        <div className="grid grid-cols-2">
          <div className="col-span-1 flex items-center">
            <svg className="mr-3 h-12" viewBox="0 0 480 510">
              <path
                fill="#fff"
          ...
          <div className="col-span-1 flex items-center">
            <svg className="mr-3 h-9" viewBox="0 0 512 512">
              <path
                fill="#fff"
          ...
          <div className="col-span-1 flex items-center">
            <svg className="mr-3 h-10" viewBox="0 0 580 540">
              <path
                fill="#fff"
          ...
          <div className="col-span-1 flex items-center">
            <svg className="mr-3 h-9" viewBox="0 0 564 512">
              <path
                fill="#fff"
      ...
      <div className="flex items-center bg-[#0833A2] xl:py-10 w-full justify-between">
        ...
        <div className="m-auto">
          ...
          <ul className="items-center hidden space-x-8 text-xl font-Poppins xl:flex">
